...
const EducationCard = ({
  ...
  return (
    <div
      className={`glass-card p-6 rounded-xl border border-bright-purple/10 relative transition-all duration-700 delay-${delay} ${
...
const CertificationCard = ({
  ...
  return (
    <div
      className={`flex items-start gap-4 p-4 rounded-xl bg-bright-purple/5 border border-bright-purple/10 transition-all duration-700 delay-${delay} ${
        isVisible ? "opacity-100" : "opacity-0 translate-y-8"
      }`}
    >
  ...
  const education = [
    {
      ...
      duration: "2020 - 2024",
      description:
        "Focused on artificial intelligence, machine learning, and data science. Participated in multiple coding competitions and AI research projects.",
      delay: 100,
    },
    {
      ...
      duration: "2018 - 2020",
      description:
        "Specialized in Computer Science with excellent academic performance. Served as School Pupil Leader for 4 years.",
      delay: 200,
    },
  ];
